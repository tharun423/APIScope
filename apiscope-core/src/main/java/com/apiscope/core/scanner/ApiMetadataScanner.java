...
/**
 * Scans all {@code @RestController} endpoints on startup and publishes
 * an {@link ApiScanCompletedEvent} for downstream ingestors.
 */
@Component
public class ApiMetadataScanner implements EndpointRepository {
    ...
    /** Reads @Operation(summary) if SpringDoc is present, otherwise converts the method name. */
